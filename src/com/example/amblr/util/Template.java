package com.example.amblr.util;
import java.util.List;

import com.example.amblr.R;
...
public class Template {
       ...
       */
      public static final String CALLBACK_URL = "amblr:pmsorhaindo";

      /**
       * The preferences use to store the request token and secret during the logging process.
       */
      public static final String PREFS_NAME = "TumblrTemp";
      ...
      public static String getConsumerKey(Context context) {
              return context.getString(R.string.tumblr_api_consumer_key);
      }
      ...
      public static String getConsumerSecret(Context context) {
              return context.getString(R.string.tumblr_api_consumer_secret);
      }
      ...
      public void startLoginProcess(Context context) {
              System.out.println(">>> "+ "startLoginProcess()");
      ...
      private class RetrieveRequestToken extends AsyncTask<Context, String, String> {
              ...
              protected String doInBackground(Context... params) {
                      ...
                      try {
                              ...
                              System.err.println("Error while trying to launch Twitter Authentication! " + e.toString());
                              return null;
                      }
              }
      ...
      public static boolean isTwitterCallback(Intent intent) {
              System.out.println(">>> "+ "isTwitterCallback()");
